...
@component('components.feature-heading', ['textcolor' => 'blue-text', 'title' => 'Nosso primeiro componente dinâmico', 'body' => 'Gosto de PHP']) 
...
@endcomponent
  ...
  <div class="row">
    ...
    <div class="col-md-4">
         ...
         @component('components.text-block', ['icon' => 'fa-flag-checkered', 'textcolor' => 'indigo-text', 'title' => 'Legal' ]) @endcomponent
         @component('components.text-block', ['icon' => 'fa-flag-checkered', 'textcolor' => 'indigo-text', 'title' => 'Inteligencia artificial' ]) @endcomponent
